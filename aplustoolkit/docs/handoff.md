...
**Fas 4 — M8 Revisioner:** [x] 4.1 lagring (`packages/fountain/revisions.ts`, store i `local.ts`; molnsynk av revisioner kvar) · [x] 4.2 versionsmeny + auto-ögonblicksbilder (`components/revisions/`, `lib/storage/useRevisions.ts`) · [ ] **▶ NÄSTA: 4.3** PDF-asterisker · [ ] 4.4 scenalternativ · [ ] 4.5 MCP-läsverktyg
