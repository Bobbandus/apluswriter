...
const paths = {
  ...
  /** A four-point spark. Where the assistant speaks. */
  sparkle: (
    <>
      <path d="M9 3.6c.5 3.2 1.5 4.7 4.7 5.4-3.2.6-4.2 2.1-4.7 5.4-.5-3.3-1.5-4.8-4.7-5.4C7.5 8.3 8.5 6.8 9 3.6z" />
      <path d="M15.2 12.6c.2 1.2.6 1.8 1.8 2-1.2.3-1.6.9-1.8 2-.2-1.1-.6-1.7-1.8-2 1.2-.2 1.6-.8 1.8-2z" />
    </>
  ),
